...
# Archivo: Archivo consolidado del GPC como % del GPC
...
dat_gpc <- rbind(dat_normal_niveles,
             dat_1980_niveles) %>% 
  mutate(fuente = "pje_gpc")


# Guardando el archivo
openxlsx::write.xlsx(dat_gpc, "02_archivos/02_03_finales/consolidado_gpc.xlsx")
